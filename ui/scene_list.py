...
class SceneList(QScrollArea):
    ...
    def bind_project(self, project: Project) -> None:
        ...
        for scene in project.scenes:
            thumb = project.paths.thumbnail_path(scene.id)
            row = SceneRow(
                scene_id=scene.id,
    ...
    def refresh_row(self, scene_id: str) -> None:
        ...
        # Refresh thumbnail (likely just regenerated by a worker).
        row.set_thumbnail(self.project.paths.thumbnail_path(scene_id))
        # Refresh dropdown values + duration in case scene fields changed.
